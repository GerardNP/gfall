        ...
        <div class="options">
          ...
          <div class="search-nav">
            <form class="" action="index.html" method="post">
              <input type="text" name="name" placeholder="Buscar juegos o usuarios" id="search-nav">
            </form>
            <svg id="search-nav-icon" class="bi bi-search" width="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
